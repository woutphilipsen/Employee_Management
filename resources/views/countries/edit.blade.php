...
@section('content')
    ...
    >
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-globe-americas"></i> Countries</h1>
    </div>
    <div class="container">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('countries.index') }}" class="btn float-right"><i class="fas fa-long-arrow-alt-left"></i> Back</a>
                    </div>
